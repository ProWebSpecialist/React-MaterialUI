...
export function TermsPolicyPage() {
    return <div className="terms-container">
        <h1 className="text-dark font-bold py-8">Terms of Service</h1>
        <div className="card px-12 py-4">
            <div className="py-8">
                <h2 className="pb-2">Rights</h2>
                <div>
                    All services provided by Benj shall be for the exclusive use of the client other than for the developer's promotional use, unless stated otherwise.
                </div>
            </div>
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Intellectual Property Rights</h2>
                <div>
            ...
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Ownership</h2>
                <div>
            ...
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Communication</h2>
                <div>
                The client can track their project's progress on the developer's website. Additonally you may reach Benj at any of the following, Discord, Skype and Email. These all can be found on the developers website.
                </div>
            </div>
            <div className="border-dotted"></div>
            <div className="py-8">
                ...
                <div>
                The client will make a full down payment prior to work commencing, unless stated otherwise. The project will then start once the payment has been received.
                </div>
            </div>
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Confidentiality</h2>
                <div>
            ...
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Developer Credit</h2>
                <div>
                Inclusion of credit for Developer on website.
                </div>
            </div>
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Data protection</h2>
                <div>
            ...
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Warranties</h2>
                <div>
            ...
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Acknowledgements and warranty limitations</h2>
                <div>
            ...
            <div className="border-dotted"></div>
            <div className="py-8">
                <h2 className="pb-2">Indemnities</h2>
                <div>
